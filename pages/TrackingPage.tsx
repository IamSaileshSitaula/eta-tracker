                    ...
                    >
                        <div className="flex flex-col items-center mr-4 z-10">
                            {isCompleted ? (
                                ...
                                <div className="relative w-10 h-10 rounded-full bg-gradient-to-br from-green-500 to-emerald-600 border-2 border-green-400 flex items-center justify-center shadow-lg">
                            ...
                            {index < stops.length - 1 && (
                                <div className={`w-1 h-14 mt-1 rounded-full ${
                                    isCompleted ? 'bg-gradient-to-b from-green-400 to-gray-300' : 'bg-gray-300'
                                }`}></div>
                            )}
                        </div>
                        <div className="pt-1 flex-1 min-w-0">
                            <div className="flex items-start justify-between gap-2">
                                <p className={`font-semibold text-base leading-tight ${
                                    isCompleted ? 'text-green-700' : isCurrent ? 'text-gray-900' : 'text-gray-700'
                                }`}>
                                    {stop.name}
                                </p>
                                {isCurrent && (
                                    <span className="px-2 py-0.5 text-xs font-bold bg-blue-100 text-blue-700 rounded-full border border-blue-300 whitespace-nowrap animate-pulse">
                                        EN ROUTE
                                    </span>
                                )}
                            </div>
                            {isCompleted ? (
                                ...
                                <p className="text-sm text-green-600 font-medium mt-1">🚀 Origin (Departed)</p>
                            ) : (
                                <div className="mt-1 space-y-1">
                                    <div className="flex items-center gap-2">
                                        <span className="text-xs text-gray-500 uppercase tracking-wide">ETA:</span>
...
export const TrackingPage: React.FC = () => {
    ...
    if (!urlTrackingNumber) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 flex items-center justify-center p-6 relative overflow-hidden">
                ...
                <div className="max-w-2xl w-full relative z-10">
                    <div className="text-center mb-8">
                        <div className="inline-block p-4 bg-white rounded-2xl mb-6 shadow-xl border border-gray-200">
                            <TruckIcon className="w-16 h-16 text-blue-600" />
                        </div>
                        <h1 className="text-6xl font-black mb-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
                            Track Your Delivery
                        </h1>
                    ...
                    <form onSubmit={handleSubmit} className="relative">
                        <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl blur opacity-10"></div>
                        <div className="relative bg-white backdrop-blur-xl border border-gray-200 rounded-2xl p-2 shadow-2xl">
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="flex-1 px-6 py-5 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 text-lg placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all"
                                />
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className="px-10 py-5 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 disabled:from-gray-300 disabled:to-gray-400 disabled:cursor-not-allowed rounded-xl font-bold text-white text-lg transition-all transform hover:scale-105 active:scale-95 shadow-lg disabled:shadow-none"
                                >
                                    {isLoading ? (
                    ...
                    <div className="mt-12 grid grid-cols-3 gap-6 text-center">
                        ...
                        <div className="p-4 bg-white/60 backdrop-blur-sm border border-gray-200 rounded-xl shadow-lg">
                            <div className="text-3xl font-bold text-purple-600 mb-1">GPS</div>
                            <div className="text-sm text-gray-600">Real-time Tracking</div>
                        </div>
                        <div className="p-4 bg-white/60 backdrop-blur-sm border border-gray-200 rounded-xl shadow-lg">
                            <div className="text-3xl font-bold text-pink-600 mb-1">ETA</div>
                            <div className="text-sm text-gray-600">Accurate Estimates</div>
                        </div>
                    </div>
                </div>
    ...
    return (
        <div className="min-h-screen bg-gray-50 text-gray-900">
            ...
            <div className="h-screen flex flex-col">
                {/* Top Header Bar */}
                <div className="bg-white backdrop-blur-xl border-b border-gray-200 shadow-sm z-20">
                    <div className="px-6 py-4">
                        <div className="flex items-center justify-between">
                            {/* Left: Logo & Tracking Number */}
                            <div className="flex items-center gap-4">
                                <div className="p-2 bg-gradient-to-br from-blue-100 to-purple-100 rounded-xl border border-blue-200">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-0.5">
                                        ...
                                        <p className="text-blue-600 font-mono font-bold text-sm">{activeRoute?.tracking_number}</p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <>
                                        ...
                                        {shipmentStatus.on_time ? (
                                            <div className="flex items-center gap-2 px-4 py-2 bg-green-50 border border-green-300 rounded-full">
                                                ...
                                                <span className="text-xs font-bold text-green-700">ON TIME</span>
                                            </div>
                                        ) : (
                                            <div className="flex items-center gap-2 px-4 py-2 bg-red-50 border border-red-300 rounded-full">
                                                <svg className="w-4 h-4 text-red-600" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd"/>
                                                </svg>
                                                <span className="text-xs font-bold text-red-700">DELAYED {shipmentStatus.late_by_min}m</span>
                                            </div>
                                        )}
                                        ...
                                        {remainingInfo && remainingInfo.remainingPercent !== null && (
                                            <div className="flex items-center gap-3 px-4 py-2 bg-blue-50 border border-blue-200 rounded-full">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-xs font-bold text-blue-700">{100 - remainingInfo.remainingPercent}%</span>
                                                </div>
                            ...
                            {shipmentStatus && (
                                <div className="text-right max-w-xs">
                                    <p className="text-xs text-gray-500 uppercase tracking-wider">Current Leg</p>
                                    <p className="text-gray-900 font-semibold text-sm truncate">{shipmentStatus.current_leg}</p>
                                </div>
                            )}
                        </div>
                    </div>
                ...
                <div className="flex-1 relative flex">
                    ...
                    <div className="absolute top-4 right-4 w-96 max-h-[calc(100vh-180px)] bg-white/95 backdrop-blur-xl border border-gray-200 rounded-2xl shadow-2xl overflow-hidden z-10">
                        ...
                        {orderedTrafficSegments.length > 0 && (
                            <div className="p-4 border-b border-gray-200 bg-red-50/50">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <span className="text-sm font-bold text-orange-800 uppercase tracking-wide">Traffic Alerts</span>
                                            ...
                                            >
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <p className="font-semibold text-gray-900 text-xs">{severityLabel}</p>
                        ...
                        <div className="flex-1 overflow-y-auto p-4 custom-scrollbar-light">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h3 className="text-xs uppercase tracking-wider text-gray-600 font-bold">
                                    Stops ({stops.length})
                                </h3>
                            </div>
                            {isLoading ? (
                                ...
                                <div className="p-4 bg-red-50 border border-red-200 rounded-xl">
                                    <p className="text-red-700 text-center text-sm font-semibold">⚠️ {error}</p>
                                </div>
                            ) : stops.length > 0 ? (
